...
public class Salary_Class {
	...
	public static void main(String[] args)throws IOException {
		...
		Salary_Class sc = new Salary_Class();
		
		int tax = sc.calcTax(salary, tax_rate);
		int m_salary = sc.calcSalary(salary,tax);
	...
	public int calcTax(int salary, double tax_rate) {
	return (int) (salary * tax_rate);
	}
	
	public int calcSalary(int salary, int tax) {
		return salary - tax;
	}
